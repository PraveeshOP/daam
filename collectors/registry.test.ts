...
describe("collector registry", () => {
  it("exposes every registered store by its stable storeId", () => {
    expect(STORE_IDS.sort()).toEqual(["evo-store", "evo-store-laptops", "itti", "itti-laptops", "itti-gaming", "mobilemandu", "mobilemandu-laptops", "mobilemandu-audio", "mobilemandu-tv", "mobilemandu-smartwatches", "mobilemandu-appliances", "neostore", "hukut-laptops", "brothermart", "itechstore", "neptronics", "zolpastore", "smartdoko", "lds"].sort());
