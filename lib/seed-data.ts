...
export const products: Product[] = [
  {
    ...
    description: "A refined everyday iPhone with the A18 chip, Camera Control, and a vibrant Super Retina XDR display.", image: image("photo-1511707171634-5f897ff02aa9"), rating: 4.8, reviewCount: 218,
